...
class OOSModel {
  ...
  OOSModel.fromJson(dynamic json) {
    _status = json['status'];
  ...
  bool? _success;
  List<Data>? _data;
OOSModel copyWith({  num? status,
  bool? success,
  List<Data>? data,
}) => OOSModel(  status: status ?? _status,
...
class Data {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['date'] = this.date;
    data['check_in_timestamp'] = this.checkInTimestamp;
    data['check_out_timestamp'] = this.checkOutTimestamp;
    data['scheduled_calls'] = this.scheduledCalls;

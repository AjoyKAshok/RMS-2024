...
//   static late final ApiServices service = ApiServices._();
...
//         SnackBar(
//           content: Center(child: Text("Logined Successfully")),
...
//     String url2 = 'https://rms2.rhapsody.ae/api/merchandiser_under_fieldmanager_details';
//     SharedPreferences prefs1 = await SharedPreferences.getInstance();
...
//     }
//   }
//   Future<AddrelieverModel> addreliver(context,emp,rel,fromdate,todate,reason) async {
...
//     }
//   }
//   Future<AddScheduledModel> addschedule(context,emp,month,days,year,outletid) async {

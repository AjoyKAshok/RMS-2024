...
//   @override
//   State<JourneyManager> createState() => _JourneyManagerState(data,this.j);
// }
...
//       out = prefs1.get("out").toString() == "" ? out : prefs1.get("out").toString();
...
//     setState(() {
//       j=="1"?i=0:i=1;
//       out2 = prefs1.get("out1").toString() == "" ? out2 : prefs1.get("out1").toString();
...
//                                                                           ),
//                                                                           Text(
//                                                                             mon.isEmpty?"Select Month":mon.toString(),
//                                                                             style:
//                                                                             TextStyle(
//                                                                               color: Colors.black.withOpacity(.5),
//                                                                             ),
...
//                                                                           .width *
//                                                                       .95,
//                                                                   height: day.length <= 1 ? 50 : (day.length * 30),
//                                                                   decoration:
//                                                                       const BoxDecoration(
//                                                                     border: Border(
//                                                                         bottom: BorderSide(

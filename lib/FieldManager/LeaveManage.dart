...
class _LeaveManageState extends State<LeaveManage> {
  ...
  String dropdownvalue2 = 'Select Reason';
  ...
  void _onSelectionChanged(DateRangePickerSelectionChangedArgs args) {
    setState(() {
      if (args.value is PickerDateRange) {
        ...
        _selectStartDate = args.value.toString();
  ...
  void _onEndSelectionChanged(DateRangePickerSelectionChangedArgs args) {
    setState(() {
      if (args.value is PickerDateRange) {
        _range = '${DateFormat('dd/MM/yyyy').format(args.value.startDate)} -'
            // ignore: lines_longer_than_80_chars
        ...
        _selectEndDate = args.value.toString();
      } else if (args.value is List<DateTime>) {
        _dateCount = args.value.length.toString();
      } else {
        _rangeCount = args.value.length.toString();
                          ...
                          Container(
                            child: Column(
                              children: [
                                ...
                                //         hintText:
                                //             'Search by Merchandiser Name or Id',
                                //         hintStyle: TextStyle(
                                                            ...
                                                            children: [
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    Text("Leave Duration : "),
                                                                    Text("3", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.orange[300]),),
                                                                  ],
                                                                ),
                                                              ),
                                                            ...
                                                            children: [
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          Text(
                                                                            _selectStartDate == ""
                                                                                ? ""
                                                                                : _selectStartDate.substring(0, 10).toString(),
                                                                            style:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                SfDateRangePicker(
                                                                                  view: DateRangePickerView.month,
                                                                                  allowViewNavigation: false,
                                                                                  onSelectionChanged: _onEndSelectionChanged,
                                                                                  selectionMode: DateRangePickerSelectionMode.single,
                                                                                  backgroundColor: Colors.black12,
                                                                                  headerHeight: 60,
                                                                                  selectionColor: const Color(0XFFE84201),
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          Text(
                                                                            _selectEndDate == ""
                                                                                ? ""
                                                                                : _selectEndDate.substring(0, 10).toString(),
                                                                            style:
                                                                                const TextStyle(color: Colors.black, fontSize: 13),
                                                                          ),
                                                                          const SizedBox(
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  GestureDetector(
                                                                    onTap: () {
                                                                      // var response = ApiServices.service.markLeave(
                                                                      //     context,
                                                                      //     merch1,
                                                                      //     _selectStartDate.substring(0, 10)
                                                                      //         .toString(),
                                                                      //     _selectEndDate
                                                                      //         .substring(0, 10)
                                                                      //         .toString(),

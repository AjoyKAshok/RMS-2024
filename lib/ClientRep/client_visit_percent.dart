...
class ClientVisitPercent extends StatefulWidget {
 Data? data;
  skipped.Data? pendingData;
  String emp = "";
  int? index;
  ClientVisitPercent(this.emp, this.index, {super.key});

  @override
  State<ClientVisitPercent> createState() => _ClientVisitPercentState(data, pendingData, emp, index);
}

class _ClientVisitPercentState extends State<ClientVisitPercent> {
 int i = 0;
  Data? data;
  skipped.Data? pendingData;
  String emp = "";

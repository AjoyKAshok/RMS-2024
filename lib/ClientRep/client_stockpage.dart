...
class ClientStockPage extends StatefulWidget {
  const ClientStockPage({super.key});
...
class _ClientStockPageState extends State<ClientStockPage> {
  ...
  void processData(List<Map<String, dynamic>> rawData) {
    ...
    for (var item in dataList) {
      ...
      if (!tempGrouped[item.storeName]!.containsKey(item.empId)) {
        tempGrouped[item.storeName]![item.empId] = [];
      }

      // Add product to employee's list
      tempGrouped[item.storeName]![item.empId]!.add(item);
    }
  ...
  Map<String, List<String>> groupProductsByStore(
    ...
    for (var item in inputList) {
      ...
      String productName = item['emp_id'];
                ...
                groupedData.isNotEmpty
                    ? ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          String storeName = groupedData.keys.elementAt(index);
                          ...
                          return Card(
                            child: Column(children: [
                              ExpansionTile(
                                ...
                                children:
                                    employeeData.entries.map((employeeEntry) {
                    ...
                    : const Card(
                        child: Padding(
                          ...
                          child: Center(
                            child: Text("No Replenishments Done for the day..."),
                          ),
                        ),
                      ),
              ],

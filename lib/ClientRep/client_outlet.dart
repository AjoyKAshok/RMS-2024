...
class ClientOutletPage extends StatefulWidget {
  Data? data;
  ClientOutletPage({super.key});

  @override
  State<ClientOutletPage> createState() => _ClientOutletPageState(data);
}

class _ClientOutletPageState extends State<ClientOutletPage> {
  int i = 0;
  Data? data;
  int lengthlist = 0;
  String userName = "";
  ...
  _ClientOutletPageState(Data? data);
  _outlet() async {
    ...
    ApiServices.service
        ...
        .then((value) => {
              setState(() {
                _outletModel = value;
                // print("Assigned Values : ${_outletModel!.data![0].store![0]}");
                // print("Returned Values : ${value.data}");
                                    ...
                                    child: Card(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              '[${_outletModel!.data![index].geoDistance}] - ${_outletModel!.data![index].outletCountry} ',
                                              style: const TextStyle(
                                                  color: Colors.black,

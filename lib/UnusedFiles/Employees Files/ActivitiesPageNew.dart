...
class Activity extends StatefulWidget {
  ...
  Activity(this.id, this.address, this.name, this.lat, this.long,
      this._desiredRadius, this.i);
  @override


  State<Activity> createState() => _ActivityState(this.id, this.address,
      this.name, this.lat, this.long, this._desiredRadius, this.i);
}
...
class _ActivityState extends State<Activity> {
  ...
  int? i;
  _ActivityState(this.id, this.address, this.name, this.lat, this.long,
      this._desiredRadius, this.i);
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: TextStyle(
                                        ...
                                        fontSize: 18,
                                        color:
                                            Color(0XFFE84201).withOpacity(.8)),
                                  ),
                                  Divider(),
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Column(
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                        "Distance from the store is more than the permissible limit. Please try from a location to the store"),
                                                                    SizedBox(
                                                                      height:
                                                                          10,
                                                                    ),
                                                                    GestureDetector(
                                                                      onTap:
                                                                          () {
                                                                        var response = ApiService.service.checkout(
                                                                            context,
                                                                            id.toString(),
                                                                            formattedDate,
                                                                            address1);
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            ElevatedButton(
                              ...
                              onPressed: () {
                                var response = (distance! <= _desiredRadius!)
                                    ? ApiService.service.checkout(context,
                                        id.toString(), formattedDate, address1)
                                    : null;
                                response!.then(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => StockCheck(id)),
                    );
                  },
                  child: SizedBox(
                    height: 110,

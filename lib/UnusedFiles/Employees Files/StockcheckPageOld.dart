...
//   String iNav = "";
//   String kmNav = "";
//   StockCheck(this.outid, this.km, this.idNav, this.addressNav, this.nameNav,
//       this.latNav, this.longNav, this.radiusNav, this.iNav, this.kmNav,
//       {super.key});
//   @override
//   State<StockCheck> createState() => _StockCheckState(data, outid, km);
// }
...
//   _StockCheckState(this.data, this.outid, this.km);
//   int i = 0;
//   int j = 0;
//   int k = 0;
//   String defaultValue = "";
...
//   List<String> searchListBarCode = [];
//   List<String> searchListNew = [];
//   var newFilteredList = [];
//   var barCodeList = [];
//   var barCodeFilterList = [];
//   var combinedList = [];
...
//                   barCodeList.add(_data!.data![i].barcode.toString());
...
//   void _filterItems() {
//     String query = _sea.text.toLowerCase();
//     setState(() {
//       filteredItems = customList.where((item) {
//         return item['product_name'].toLowerCase().contains(query) || item['barcode'].toLowerCase().contains(query);
//       }).toList();
//       // filteredItems = customList.where((item) {
//       //   return item['barcode'].toLowerCase().contains(query);
//       // }).toList();
//     });
//     print("The List of Filtered Items : $filteredItems");
//   }
...
//         barCodeList.clear();
//         barCodeList.addAll(searchListBarCode);
//         combinedList.addAll(filteredList);
//         combinedList.addAll(barCodeList);
...
//                 context,
//                 MaterialPageRoute(
//                     builder: (context) => Activity(idNav!, addressNav!,
...
//                                                   // newFilteredList = combinedList
//                                                   //     .where((item) => item
//                                                   //         .toLowerCase()
//                                                   //         .contains(query
//                                                   //             .toLowerCase()))
//                                                   //     .toList();
//                                                   // newFilteredList = barCodeList
...
//                                                       onTap: () {
//                                                         setState(() {
//                                                           j = customList.indexOf(
//                                                               filteredItems[
//                                                                       index][
//                                                                   'product_name']);
//                                                           print(
//                                                               "Index of Selected Product : $j");
//                                                           _sea.text = customList[
//                                                                   j]
//                                                               ['product_name'];
//                                                           searchStarted = false;
//                                                           queryStarted = false;

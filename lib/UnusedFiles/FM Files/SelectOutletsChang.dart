...
//                   filteredList.add(_outletModel!.data![i].store![0].storeCode.toString()+" - "+ _outletModel!.data![i].store![0].storeName.toString());
//                 }
//               })
//             });
//   }
...
//                                 setState(() {
//                                   _isChecked![index] = newValue!;
//                                   name.add(filteredList1[index].toString().substring(0,8));
//                                   storeName.add(filteredList1[index].toString().substring(10));
//                                   print(" Names : $name");
//                                   print("Store Names : $storeName");
//                                 });
//                               },

...
class YettoVisit extends StatefulWidget {
  Data? data;
  @override
  State<YettoVisit> createState() => _YettoVisitState(this.data);
}

class _YettoVisitState extends State<YettoVisit> {
  int i=0;
  Data? data;
  String day="";
  int lengthlist = 0;
  var myList = [];
  YettoVisitModel? _data;
  _YettoVisitState(Data? data);
  _gettodayplanned() {
    ApiService.service.yettovisitJourney(context).then((value) => {
      setState(() {
        _data = value;
